...
const Categories = () => {
    ...
    <a className="card" href="/#">
      ...
      <div className="card__content">
        <p className="card__category">Mens</p>
        <h3 className="card__heading">Premium Mens Watch</h3>
      </div>
    </a>
    <a className="card" href="/#">
      ...
      <div className="card__content">
        <p className="card__category">Womens</p>
        <h3 className="card__heading">Premium Womens Watch</h3>
      </div>
    </a>
    <a className="card" href="#/">
      ...
      <div className="card__content">
        <p className="card__category">Kids</p>
        <h3 className="card__heading">Best Kids Watch</h3>
      </div>
    </a>
    <a className="card" href="/#">
      ...
      <div className="card__content">
        <p className="card__category">Men ,women</p>
        <h3 className="card__heading">Qulity Smart Watch</h3>
      </div>
    </a>
