...
const AdminAddProduct = () => {
    ...
    return (
        ...
        <input type="number" {...register("key", {required: true, min: 1, max: 99 })} placeholder="Unique Number Or Key" />
      ...
      <input type="number" {...register("price", { required: true, min: 18, max: 92129 })} placeholder="Discount Price" />
      <input type="number" {...register("mainPrice", {required: true, min: 1, max: 99 })} placeholder="Main Price" />
